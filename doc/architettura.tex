...
% Quest'ultimo è compatibile soltanto con Python 2, per cui abbiamo sfruttato l'interoperabilità tra nodi programmati in diversi linguaggi di ROS per confinare l'utilizzo di Python 2, ormai deprecato, alla più piccola parte possibile dell'architettura. 
